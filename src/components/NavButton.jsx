...
const NavButtons = ({path, img, btnName, taskCount}) => {
  ...
  const activeClassName = `mb-1 w-full border-l-4 rounded bg-gray-200 hover:bg-gray-300 hover:border-l-4 border-l-violet-600 hover:border-l-violet-600 hover:rounded-l cursor-pointer ${btnName === "About" ? "mt-auto" : ""}`
  const inactiveClassName = `mb-1 w-full border-l-4 rounded hover:bg-gray-200 hover:border-l-4 border-l-white hover:border-l-violet-600 hover:rounded-l cursor-pointer ${btnName === "About" ? "mt-auto" : ""}`
